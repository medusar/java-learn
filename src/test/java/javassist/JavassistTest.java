...
public class JavassistTest {
    ...
    public void testNewInstance() throws Exception {
        ...
        CtClass ctClass = pool.get("com.medusar.compile.Hello2");
    ...
    public void testCreateClass() throws CannotCompileException, NotFoundException, SecurityException, NoSuchMethodException,
            IllegalArgumentException, IllegalAccessException, InvocationTargetException, InstantiationException, IOException {
        ClassPool pool = ClassPool.getDefault();
        // 创建类
